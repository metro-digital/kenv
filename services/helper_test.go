...
func TestHelperProcess(t *testing.T) {
  ...
  case "case2":
    fmt.Fprintf(os.Stderr, "gpg: Oops: lock already held by us")
  case "case3":
    fmt.Fprintf(os.Stderr, "gpg: invalid option")
  case "case4":
    fmt.Fprintf(os.Stderr, "[GNUPG:] KEY_CONSIDERED E341BE2FA255F0469E952011BD09B4A7A2A2A496 0")
  case "case5":
    fmt.Fprintf(os.Stderr, `gpg: key "E341BE2FA255F0469E952011BD09B4A7A2A2A496" not found
    [GNUPG:] DELETE_PROBLEM 1`)
  case "case6":
    content, _ := ioutil.ReadFile("fixtures/kustomize.output")
    fmt.Fprintf(os.Stdout, string(content))
  case "case7":
    fmt.Fprintf(os.Stderr, `Error: env source "application.secrets.yaml": sops could not decrypt: Error getting data key: 0 successful groups required, got 0
